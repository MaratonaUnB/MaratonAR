...
/* ... (Scanner e outros estilos mantidos) ... */
...
.btn-test { position: fixed; bottom: 30px; right: 30px; z-index: 1000; background: #F92672; color: #fff; border: none; padding: 12px 24px; border-radius: 8px; font-weight: bold; cursor: pointer; font-family: 'JetBrains Mono', monospace; }
...
.download-btn {
  ...
  border: none;
  color: #F8F8F2;
  padding: 12px 4px; /* Reduzi padding lateral */
  font-family: 'JetBrains Mono', monospace;
  font-size: 9px; /* Reduzi a fonte para caber Download */
  font-weight: bold;
  cursor: pointer;
  display: flex;
  flex-direction: row;
  ...
  letter-spacing: 0px; /* Reduzi letter-spacing */
}
...
.insta-icon {
  width: 14px; /* Ícone um pouco menor */
  height: 14px;
  fill: #F92672;
}
